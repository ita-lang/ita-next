...
| [0017](ADR-0017-lowering-de-conformance-f7.md) | **Lowering de conformance (F7)** — merge-na-Class local · defaults por stub+static · box de valor na fronteira existencial · Int = decl `.tu` + backing `dart:core` | **`proposed`** — 3 rulings pedidos (§6) | 2026-07-16 |
