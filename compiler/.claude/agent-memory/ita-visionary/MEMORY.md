...
- [W0 da LT-F6b Fatia 3 (produto/List/String)](spec-014-ltf6b-fatia3-identity-review.md) — liberado-c/-ressalva; substância itaiana; 🔴 ATRIBUIÇÃO do ban Str-interp **FECHOU em 07-24** (tasks.md:41 → `[x]`, detail corrigido p/ class).
- [Gate de identidade pré-F7 (2026-07-24)](f7-gate-identity-review.md) — base ITAIANA, zero violação; chão-012 e corte-014 passam; achado: `⚠️ Ao dono` de `collect.dart:89` é mentira-por-obsolescência (§B-7 re-ratificado no ADR-0016 §E); 2 pendências bloqueiam F7 (self/closure em default de param).
