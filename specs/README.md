...
- **`make test` (front-end F1–F6): 935 verdes** — medido em 2026-08-31. Eram **922** em `3a2651a`
  (e em 2026-08-27 — o CA11 não tocou o front-end); os **+13** são o grupo *"errata 010 §4.1"*,
